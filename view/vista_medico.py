...
#=======================================================================================================================
        """Se crea el titulo"""
        titulo = tk.Label(self, text = "MÉDICOS", bg = "#E8D9C5", fg = "#6B4F3A", font = ("Arial", 20, "bold"))
        titulo.pack(pady = 10)
#=======================================================================================================================
        """Se crea formulario"""
...
#=======================================================================================================================
        """Se crea id_especialidad"""
        tk.Label(frame_form, text="ID Especialidad:", bg="#F5EBDD", font=('Arial', 11)).grid(row=2, column=2, padx=5, pady=5)
        self.entry_id_especialidad= tk.Entry(frame_form, font=('Arial', 11))
        self.entry_id_especialidad.grid(row=2, column=3, padx=5, pady=5)
#=======================================================================================================================
...
#=======================================================================================================================
        """Se crea consultar por provincia y especialidades"""
        ...
        # Especialidads
        self.entry_id_especialidad_consulta = tk.Entry(frame_consultas, font=('Arial', 11))
        self.entry_id_especialidad_consulta.pack(side ="left", padx=5)
        self.btn_consulta_especialidades = tk.Button(frame_consultas,
                                                    text="Consultar por\n ID Especialidad",
                                                    bg="#C8A27A",
                                                    fg="white",
                                                    font=('Arial', 11, 'bold'))
        self.btn_consulta_especialidades.pack(side ="left", padx=5)
        # =======================================================================================================================
        """Se crea la tabla"""
        columnas = ("cedula", "nombre", 'telefono', "correo", "provincia", 'especialidad')
...
# ======================================================================================================================
    def obtener_especialidad(self):
        """Retorna el especialidad seleccionado en el área de consulta por especialidad"""
        return self.entry_id_especialidad_consulta.get()
#=======================================================================================================================
    def obtener_datos(self):
        ...
        return (
            ...
            self.entry_id_especialidad.get(),
        )
#=======================================================================================================================
